...
public class HelperUtil 
{
	...
	public static void printEntityList(ArrayList<Item> items)
	{
		...
		System.out.println("Entity, Buy/Sell, AgreedFx, Currency, Instruction Date , Settlement Date, Actual Settlement Date, Units, Price per Unit, Rank");
		System.out.println("==============================================================================================================================");
	...
	public static void printDailySummary(ArrayList<Item> items) 
	{
		...
		while(itr.hasNext())
		{
			...
			System.out.println("Date:"+value.getKey()+"  Incoming transaction:"+ value.getValue().getIncomingTransaction()+" USD"
